# we consider a nondeterministic bi-infinite one-tape Turing machine
...
def selecting_move(set_of_moves):
    n = len(set_of_moves)-1 
    i = random.randint(0,n)
    
    return set_of_moves[i] 
...
def TM_move(conf_left,conf_right,curr_state,trans_func):
    ...
    v = selecting_move(trans_func[u]) # the output of transition function
